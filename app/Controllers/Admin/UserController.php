...
class UserController
{
    ...
    public function AddPostUser()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if(!$this->checkValidate()){
                header(header: "Location: " . BASE_URL . "?role=admin&act=add-user");
                exit();
            }
            ...
            if ($message) {
                ...
                header(header: "Location: " . BASE_URL . "?role=admin&act=all-user");
                exit();
            } else {
    ...
    public function updatePostUser()
    {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            if(!$this->checkValidate()){
                header(header: "Location: " . BASE_URL . "?role=admin&act=update-user&id=" . $_GET['id']);
                exit();
            }
