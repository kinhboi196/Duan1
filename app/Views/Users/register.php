...
<head>
    <meta charset="utf-8">
    <title>Gizom Home - Đăng ký</title>
            ...
            <div class="container">
                <div class="form-register-wrap">
                    <div class="flat-title align-items-start gap-0 mb_30 px-0">
                        ...
                        ?>
                        <p class="text_black-2">Đăng ký ngay để nhận thông báo mới nhất về các đơn hàng với giá hời nhất tại cửa hàng của chúng tôi!.</p>
                    </div>
                    <div>
                        <form class="" id="register-form" action="<?= BASE_URL ?>?act=post-register" method="post"
                            ...
                            <div class="tf-field style-1 mb_15">
                                <input class="tf-field-input tf-input" placeholder=" " type="text" id="property3"
                                    name="email">
                                <label class="tf-field-label fw-4 text_black-2" for="property3">Tên tài khoản/Email *</label>
                            </div>
                            ...
                            <div class="mb_20">
                                <button type="submit"
                                    class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Đăng ký</button>
                            </div>
                            <div class="text-center">
                                <a href="<?= BASE_URL ?>?act=login" class="tf-btn btn-line">Đã có sẵn tài khoản? Đăng nhập tại đây<i class="icon icon-arrow1-top-left"></i></a>
                            </div>
                        </form>
                    </div>
                </div>
