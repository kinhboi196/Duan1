...
<!-- Mirrored from themesflat.co/html/ecomus/shop-default.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2024 14:42:15 GMT -->
...
<body class="preload-wrapper">
                ...
                <div class="wrapper-control-shop">
                    ...
                    <div class="grid-layout wrapper-shop" data-grid="grid-4">
                        ...
                        <?php foreach ($listProduct as $key => $value): ?>
                            <div class="card-product" data-price="16.95">
                                ...
                                <div class="card-product-info">
                                    <a href="<?= BASE_URL ?>?act=product-detail&product_id=<?= $value->id ?>" class="title link"><b><?= $value->name ?></b></a>
    ...
    <div class="facet-title" data-bs-target="#product-search" data-bs-toggle="collapse"
        aria-expanded="true" aria-controls="product-search">
        <span>Product name</span>
        <span class="icon icon-arrow-up"></span>
    </div>
    <form action="<?= BASE_URL ?>" method="get">
        <div id="product-search" class="collapse show">
            <div class="d-flex">
                <input type="hidden" name="act" value="shop" />
                <input type="text" placeholder="Tìm kiếm sản phẩm" name="product-name">
...
<div class="widget-facet wd-categories">
    <div class="facet-title" data-bs-target="#categories-list" data-bs-toggle="collapse" 
        aria-expanded="true" aria-controls="categories-list">
                    ...
                    <div id="availability" class="collapse show">
                        <ul class="tf-filter-group current-scrollbar mb_36">
                            <li class="list-item d-flex gap-12 align-items-center">
                                <a <?php
                                echo 'href= "' . BASE_URL . '?act=shop"'; ?> class="label"><span>Mặc
                                        định</span>&nbsp;<span></span></a>
                            </li>
                            <li class="list-item d-flex gap-12 align-items-center">
                                <a <?php
                                ...
                                ?> class="label"><span>In
                                        Stock</span>&nbsp;<span>(<?= $stock[0]->instock ?>)</span></a>
                            </li>
                            <li class="list-item d-flex gap-12 align-items-center">
                                <a <?php
                                if (isset($_GET['category_id'])) {
                                ...
                                ?> class="label"><span>Out of
                                        stock</span>&nbsp;<span>(<?= $stock[1]->outstock ?>)</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="widget-price filter-price">
                                <div class="d-flex">
                                    ...
                                    <input type="number" placeholder="Min" class="me-3" name="min"
                                        value="<?= isset($_GET['min']) ? htmlspecialchars($_GET['min']) : '' ?>" />
                                    <input type="number" placeholder="Max" name="max"
                                        value="<?= isset($_GET['max']) ? htmlspecialchars($_GET['max']) : '' ?>" />
                                </div>
                ...
                <div class="widget-facet">
                    ...
                    <div id="color" class="collapse show">
                        <ul class="tf-filter-group filter-color current-scrollbar mb_36">
                            ...
                            <li class="list-item d-flex gap-12 align-items-center">
                                <input type="checkbox" name="color" class="tf-check-color bg_dark-beige" id="dark-beige"
                                    value="dark-beige">
                                <label for="dark-beige" class="label"><span>Dark
                                        Beige</span>&nbsp;<span>(1)</span></label>
                            </li>
                            <li class="list-item d-flex gap-12 align-items-center">
                                <input type="checkbox" name="color" class="tf-check-color bg_dark-blue" id="dark-blue"
                                    value="dark-blue">
                                <label for="dark-blue" class="label"><span>Dark
                                        Blue</span>&nbsp;<span>(3)</span></label>
                            </li>
                            <li class="list-item d-flex gap-12 align-items-center">
                                <input type="checkbox" name="color" class="tf-check-color bg_dark-green" id="dark-green"
                                    value="dark-green">
                                <label for="dark-green" class="label"><span>Dark
                                        Green</span>&nbsp;<span>(1)</span></label>
                            </li>
                            <li class="list-item d-flex gap-12 align-items-center">
                                <input type="checkbox" name="color" class="tf-check-color bg_dark-grey" id="dark-grey"
                                    value="dark-grey">
                            ...
                            <li class="list-item d-flex gap-12 align-items-center">
                                <input type="checkbox" name="color" class="tf-check-color bg_light-blue" id="light-blue"
                                    value="light-blue">
                            ...
                            <li class="list-item d-flex gap-12 align-items-center">
                                <input type="checkbox" name="color" class="tf-check-color bg_light-grey" id="light-grey"
                                    value="light-grey">
                                <label for="light-grey" class="label"><span>Light
                                        Grey</span>&nbsp;<span>(1)</span></label>
                            </li>
                            <li class="list-item d-flex gap-12 align-items-center">
                                <input type="checkbox" name="color" class="tf-check-color bg_light-pink" id="light-pink"
                                    value="light-pink">
                                <label for="light-pink" class="label"><span>Light
                                        Pink</span>&nbsp;<span>(2)</span></label>
                            </li>
                            <li class="list-item d-flex gap-12 align-items-center">
                                <input type="checkbox" name="color" class="tf-check-color bg_purple" id="light-purple"
                                    value="light-purple">
    ...
    <style>
        .modalDemo .wrap {
            ...
            /* Căn hai phần từ trên cùng */
        }

        .modalDemo .tf-product-media-wrap {
            flex: 1;
            /* Chiếm một phần không gian (tự điều chỉnh theo nội dung) */
            max-width: 50%;
            /* Giới hạn chiều rộng tối đa */
            box-sizing: border-box;
            /* Bao gồm cả padding và border */
        }

        .modalDemo .tf-product-info-wrap {
            flex: 1;
        ...
        .modalDemo .tf-product-media-wrap img {
            display: block;
            /* Loại bỏ khoảng trống mặc định của ảnh */
            width: 100%;
    ...
    <?php foreach ($listProduct as $key => $value): ?>
        <div class="modal fade modalDemo" id="quick_view<?= $value->id ?>">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="header">
                        <span class="icon-close icon-close-popup" data-bs-dismiss="modal"></span>
                        ...
                        <div class="tf-product-info-wrap position-relative">
                            <div class="tf-product-info-list">
                                <div class="tf-product-info-title">
                                    <h5><a class="link" href="product-detail.html"><?= $value->name ?></a></h5>
                                </div>
                                ...
                                <div class="tf-product-info-price">
                                    <div class="price"><s><?= number_format($value->price) ?> VND</s></div>
                                </div>
                                <div class="tf-product-info-price">
                                    <div class="price price-sale"><?= number_format($value->price_sale) ?> VND</div>
                                </div>
                                ...
                                <div class="tf-product-info-quantity">
                                    <div class="quantity-title fw-6">Quantity</div>
                                    <div class="quantity-title fw-6"><?= $value->stock ?></div>
                                </div>
                                <div class="tf-product-info-buy-button">
                                    <form class="">
                                        <a href="javascript:void(0);"
                                            class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart"><span>Add
                                                to cart -&nbsp;</span><span class="tf-qty-price"><?= $value->price_sale ?>
                                                VND</span></a>
                                        <a href="javascript:void(0);"
                                ...
                                <div>
                                    <a href="<?= BASE_URL ?>?act=product-detail&product_id=<?= $value->id ?>" class="tf-btn fw-6 btn-line">View full details<i
                                            class="icon icon-arrow1-top-left"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="assets/Users/js/shop.js"></script>
    <script type="text/javascript" src="assets/Users/js/main.js"></script>
</body>


<!-- Mirrored from themesflat.co/html/ecomus/shop-default.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2024 14:42:16 GMT -->
