...
<head>
    <meta charset="utf-8">
    <title>Gizom Home - Đăng nhập</title>
            ...
            <div class="container">
                <div class="tf-grid-layout lg-col-2 tf-login-wrap">
                    <div class="tf-login-form">
                        <div id="recover">
                            <h5 class="mb_24">Đặt lại mật khẩu</h5>
                            <p class="mb_30">Chúng tôi sẽ gửi cho bạn email khôi phục mật khẩu</p>
                            <div>
                                <form class="" id="login-form" action="#" method="post" accept-charset="utf-8"
                                    ...
                                    <div class="mb_20">
                                        <a href="#login" class="tf-btn btn-line">Hủy</a>
                                    </div>
                                    <div class="">
                                        <button type="submit"
                                            class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Đặt lại mật khẩu</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div id="login">
                            ...
                            <div>
                                <form class="" id="login-form" accept-charset="utf-8"
                                    action="<?= BASE_URL ?>?act=post-login" method="post">
                                    <div class="tf-field style-1 mb_15">
                                    ...
                                    <div class="">
                                        <button type="submit"
                                            class="tf-btn w-100 radius-3 btn-fill animate-hover-btn justify-content-center">Đăng nhập</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                    ...
                    <div class="tf-login-content">
                        ...
                        <p class="mb_20">Đăng ký ngay để nhận thông báo mới nhất về các đơn hàng với giá hời nhất tại cửa hàng của chúng tôi!.</p>
                        <a href="<?= BASE_URL ?>?act=register" class="tf-btn btn-line">Đăng ký<i
