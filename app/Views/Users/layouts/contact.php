    ...
    <div class="px_15 lg-px_40">
        <div class="tf-top-bar_wrap grid-3 gap-30 align-items-center">
            <ul class="tf-top-bar_item tf-social-icon d-flex gap-10">
                <li><a href="https://www.facebook.com/hoainamfpt/" target="_blank" class="box-icon w_28 round social-facebook bg_line"><i
                ...
                <li><a href="https://www.instagram.com/hoainam279/" target="_blank" class="box-icon w_28 round social-instagram bg_line"><i
                            class="icon fs-12 icon-instagram"></i></a></li>
                <li><a href="https://www.tiktok.com/@hoainam589" target="_blank" class="box-icon w_28 round social-tiktok bg_line"><i
            ...
            <div class="top-bar-language tf-cur justify-content-end">
                ...
                <div class="tf-currencies">
                    <select class="image-select center style-default type-currencies">
                        <option data-thumbnail="assets/Users/images/country/fr.svg">EUR € | France</option>
                        <option data-thumbnail="assets/Users/images/country/de.svg">EUR € | Germany</option>
                        <option data-thumbnail="assets/Users/images/country/us.svg">USD $ | United States
                        </option>
                        <option selected data-thumbnail="assets/Users/images/country/vn.svg">VND ₫ | Vietnam</option>
                    </select>
                </div>
