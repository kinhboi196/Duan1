...
<head>
    <meta charset="utf-8">
    <title>Gizom Home - Trang chủ</title>
                                        ...
                                        <div class="collection-item style-left hover-img">
                                            <div class="collection-inner">
                                                ...
                                                <div class="collection-content">
                                                    <a href="<?= BASE_URL ?>?act=shop&category_id<?= $value->id ?>"
                                                        class="tf-btn collection-title hover-icon fs-15"><span>
                                                            <?= $value->name ?>
                        ...
                        <div class="tf-product-info-wrap position-relative">
                            <div class="tf-product-info-list">
                                <div class="tf-product-info-title">
                                    <h5><a class="link" href="<?= BASE_URL ?>?act=product-detail&product_id=<?= $value->id ?>"><?= $value->name ?></a></h5>
                                </div>
