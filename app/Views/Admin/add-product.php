                                ...
                                <div class="wg-box">
                                    ...
                                    <form action="<?= BASE_URL?>?role=admin&act=add-post-product" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="pricesale" id="pricesale" placeholder="Price Sale">
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" name="description" id="description" placeholder="Description"  class="form-control"></textarea>
                                        </div>
                                       <!-- <div class="mb-3">
                                           <h3>List Image</h3>
